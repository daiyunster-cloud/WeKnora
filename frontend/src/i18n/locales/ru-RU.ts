...
/example\.(net|org)/`,
  ...
  platform: {
    ...
    subtitle: 'Корпоративная · AI система знаний',
    description: 'Интеграция исследовательских данных и интеллектуального анализа для обоснованных инвестиционных решений',
    rag: 'Глубокое отраслевое исследование',
    hybridSearch: 'Умный инвестиционный анализ',
    localDeploy: 'Многоисточниковый поиск данных',
